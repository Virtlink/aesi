...
class NotTerm(
    ...
    companion object {
         ...
         */
        val constructor = TermConstructorOfT("NotTerm", 1, { create(it) })
         ...
         */
        @JvmStatic fun create(children: List<ITerm>): NotTerm {
    ...
    private inner class ChildrenList: AbstractList<ITerm>() {
        ...
        override val size: Int
            get() = NotTerm.constructor.arity

        override fun get(index: Int): ITerm
                = when (index) { 
                    0 -> this@NotTerm.expression
