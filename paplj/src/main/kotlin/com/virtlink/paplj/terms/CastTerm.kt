...
class CastTerm(
    ...
    companion object {
         ...
         */
        @JvmStatic fun create(children: List<ITerm>): CastTerm {
            ...
            return CastTerm(expression, type)
        }
    }
    ...
    private inner class ChildrenList: AbstractList<ITerm>() {
        ...
        override val size: Int
            get() = CastTerm.constructor.arity

        override fun get(index: Int): ITerm
                = when (index) { 
                    0 -> this@CastTerm.expression
                    1 -> this@CastTerm.type
