---
title: PapljMemberExprImpl - aesi-intellij
---

[aesi-intellij](../../index.html) / [org.metaborg.paplj.psi.impl](../index.html) / [PapljMemberExprImpl](.)

# PapljMemberExprImpl

`open class PapljMemberExprImpl : `[`PapljExprImpl`](../-paplj-expr-impl/index.html)`, `[`PapljMemberExpr`](../../org.metaborg.paplj.psi/-paplj-member-expr/index.html)

### Constructors

| [&lt;init&gt;](-init-.html) | `PapljMemberExprImpl(node: ASTNode)` |
...
| [getDot](get-dot.html) | `open fun getDot(): PsiElement` |
...
| [getId](get-id.html) | `open fun getId(): PsiElement` |
